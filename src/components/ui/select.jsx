    ...
    return (
      <DrawerContent className="pb-8">
        <div className={cn("mx-auto w-full max-w-sm", className)} {...props}>
          <div className="p-4">
            <div className="flex items-center justify-center w-12 h-1.5 rounded-full bg-muted mx-auto mb-4" />
            {children}
          </div>
        </div>
      </DrawerContent>
...
const SelectLabel = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Label
      ref={ref}
      className={cn("px-2 py-1.5 text-sm font-semibold", isMobile && "text-lg", className)}
      {...props}
    />
  )
})
