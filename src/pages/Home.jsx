...
const subscriptionPlans = [
  {
    ...
    highlight: false,
    tag: null,
    description: "Perfetto per chi si allena di mattina",
    benefits: [
      "Accesso dalle 00:00 alle 11:00",
      "Tutte le palestre Fit Abb convenzionate",
  ...
  },
  {
    ...
    highlight: false,
    tag: null,
    description: "Flessibilità totale senza vincoli annuali",
    benefits: [
      "Ingressi illimitati H24",
      "Accesso dove disponibile",
      "Allenamento libero",
