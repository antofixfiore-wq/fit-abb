    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">7. Diritti dell'utente</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">8. Cookie e tecnologie simili</h2>
            <p>
